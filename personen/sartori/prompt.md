...
Kopieren, ohne dass man etwas zusammensetzen muss.

Die zehn Dateien gehören in `bilder/` neben diese Datei und heißen
`neutral.webp` bis `abweisend.webp`; `sartori.js` erwartet sie so.
